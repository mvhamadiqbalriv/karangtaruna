                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-style-1">
                                ...
                                <input type="text" @error('berita_judul') class="form-control is-invalid" @enderror name="berita_judul"
                                       ...
                                       value="{{ old('berita_judul')}}" required>
                                @error('berita_judul')
                        ...
                        <div class="col-12">
                            <div class="input-style-1">
                                ...
                                <textarea name="berita_isi" id="berita_isi" cols="30" rows="5" required>{{old('berita_isi')}}</textarea>
                                @error('berita_isi')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-12">
                            <div class="input-style-1">
                                ...
                                <input @error('berita_image') class="form-control is-invalid" @enderror type="file"
                                       name="berita_image" id="berita_image" required>
                                @error('berita_image')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-12">
                            <div class="input-style-1">
                                ...
                                <input type="date" @error('berita_tanggal') class="form-control is-invalid"
                                       @enderror name="berita_tanggal" id="berita_tanggal" placeholder="{{ __('Tanggal') }}"
                                       required>
