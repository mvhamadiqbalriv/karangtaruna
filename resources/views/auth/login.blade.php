                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-style-1">
                                ...
                                <input @error('username') class="form-control is-invalid" @enderror type="text" name="username" id="username" placeholder="{{ __('Username') }}" required autocomplete="username" autofocus>
                                @error('username')
