<ul>
    ...
    <li class="nav-item @if(request()->routeIs('sekilas.show')) active @endif">
        <a href="{{ route('sekilas.show') }}">
            <span class="icon">
                <svg
                  width="22"
                  height="22"
            ...
            <span class="text">{{ __('Sekilas Organisasi') }}</span>
        </a>
    </li>

    <li class="nav-item @if(request()->routeIs('struktur.show')) active @endif">
        <a href="{{ route('struktur.show') }}">
            <span class="icon">
                <svg
                  width="22"
                  height="22"
            ...
            <span class="text">{{ __('Struktur Organisasi') }}</span>
        </a>
    </li>

    <li class="nav-item @if(request()->routeIs('kegiatan.index')) active @endif">
        <a href="{{ route('kegiatan.index') }}">
            ...
            <span class="text">{{ __('Kegiatan') }}</span>
        </a>
    </li>

    <li class="nav-item @if(request()->routeIs('berita.index')) active @endif">
        <a href="{{ route('berita.index') }}">
            ...
            <span class="text">{{ __('Berita') }}</span>
        </a>
    </li>
    ...
    <li class="nav-item @if(request()->routeIs('users.index')) active @endif">
        <a href="{{ route('users.index') }}">
            ...
            <span class="text">{{ __('Keanggotaan') }}</span>
        </a>
    </li>
